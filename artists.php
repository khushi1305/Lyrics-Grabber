			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="artists.html"><i class="lnr lnr-users"></i> <span>Artists</span></a></li> 
					...
					<!--//pop-up-box -->
						...
						<div class="browse">
								<div class="tittle-head two">
									<h3 class="tittle">Artists</span></h3>
...
<form method="post" enctype="multipart/form-data" action="artists2.php">
...
<input type="submit" value="Display All Artists" name="disp"/>
			  ...
			  <!--body wrapper end-->
				...
				<div class="footer-grid">
					...
					<ul class="list1">
					  ...
					  <li><a href="artists.html">All Songs</a></li>
					  <li><a href="browse.html">Albums</a></li>
					  <li><a href="artists.html">New Collections</a></li>
