			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="uploadVideos1.php"><i class="lnr lnr-indent-increase"></i> <span>Upload videos</span></a></li>
...
<br><br>
Selet The Image For The Artist<br>
<input type="file" name="imageFile" id="a"><br>
<br><br>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		{
			$image_path="images/artist/default.jpg";
		}
...
function display()
{
	...
	echo "<table border='2' width='60%'><tr><td>Name</td><td>Image</td></tr>";
	while($row=mysql_fetch_array($r))
		{
			echo "<tr><td>".$row['name']."</td><td>".$row['image'];
		}
	mysql_close($conn);
}
function save($name,$imageName)
{
	$conn=mysql_connect('localhost','root','');
	mysql_select_db("music_warehouse",$conn);
	$query="insert into artist values('{$name}','{$imageName}');";
