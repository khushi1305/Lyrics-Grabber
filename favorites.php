 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    <section>
 	 ...
 	 <!-- /w3l-agile -->
			  ...
			  <h3 class="tittle"> Favourites </h3>
			  <br> <br> <br>
			  
			  
			  
			  <div class="list-group list-group-alternate"> 
				<a href="#" class="list-group-item"> <i class="ti ti-email"></i> Nazar na lag jaaye </a> 
				<a href="#" class="list-group-item"> <i class="ti ti-eye"></i> Leja Re </a> 
				<a href="#" class="list-group-item"> <i class="ti ti-headphone-alt"></i> Tum se </a> 
				<a href="#" class="list-group-item"> <i class="ti ti-comments"></i> Qaafirana </a> 
				<a href="#" class="list-group-item"> <i class="ti ti-bookmark"></i> Zehnaseeb </a> 
...
<input type="submit" value="Display Favourites" name="disp"/>
