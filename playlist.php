 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    <section>
 	 ...
 	 <!-- /w3l-agile -->
			  ...
			  <!-- body -->
				<br>
			  <h3 class="tittle">Create Playlist</h3><br>
...
mysql_query("insert into playlist(video_name) values('$video_path')");
...
$query=mysql_query("select * from playlist");
...
<table >
<tr> <td> Select music to add in playlist...</td></tr>
<tr>
...
<tr><td>
<div class="sign-right">
<input type="submit" value="Add to playlist" name="upd">
<input type="submit" value="Remove song" name="del"> 
</div>
</div>
